...
function HomeAbout() {
  return (
    <div
      ...
      style={{ background: "var(--bs-red)", margin: "20px auto" }}
    >
      <div className="row mb-5">
        <div className="col-md-8 col-xl-6 text-center mx-auto">
          <h2 className="text-white">Welcome to Roomie4Me</h2>
          <p>An Advanced Roommate Search App</p>
        </div>
      </div>
        ...
        <div className="col">
          <div className="d-flex">
            ...
            <div className="px-3">
              ...
              <p>
                Take advantage of the age of AI through our AI powered content
                tagging to help you find just the perfect match.
              </p>
            </div>
          </div>
        </div>
